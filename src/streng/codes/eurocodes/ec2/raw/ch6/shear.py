...
def VRdc(CRdc, Asl, fck, σcp, bw, d, units='N-mm', include_intermediates = False):
    ...
    Args:
        ...
        units (str): Units used for calculations. Default: 'N-mm'. Also suppoerted: 'kN-m' 
...
def VRdmax(bw, d, fck, fyk, fywk, θ, αcw=1.0, γc=1.5, units='N-mm-rad', include_intermediates = False):
    ...
    if include_intermediates == True:
        ...
        return _VRdmax['value']


def VRds(nw, diaw, d, fyk, fywk, θ, s, γs=1.15, units='N-mm-rad', include_intermediates = False):
